...
env.Append(CPPPATH=[
    ...
    'Pods/FirebaseCore/Interop/CoreDiagnostics/Public',
    'Pods/GoogleDataTransport/GoogleDataTransport/GDTCCTLibrary/Public',
    'Pods/GoogleDataTransport/GoogleDataTransport/GDTCORLibrary/Public',
    'Pods/FirebaseAuth/FirebaseAuth/Sources/Public',
    'Pods/FirebaseAuth/Interop/Auth/Public',
    'Pods/FirebaseFirestore/Firestore/Source/Public',
    'Pods/FirebaseFirestore/Interop/Auth/Public',
    'Pods/FirebaseCoreDiagnostics/Interop/CoreDiagnostics/Public',
    'Pods/FirebaseCoreDiagnostics/Firebase/CoreDiagnostics/FIRCDLibrary/Public',
    'Pods/FirebaseInstallations/FirebaseInstallations/Source/Library/Public',
    'Pods/Headers/Public',
    'Pods/GoogleUtilities/GoogleUtilities/UserDefaults/Public',
    'Pods/GoogleUtilities/GoogleUtilities/MethodSwizzler/Public',
    'Pods/GoogleUtilities/GoogleUtilities/Logger/Public',
    'Pods/GoogleUtilities/GoogleUtilities/Network/Public',
    'Pods/GoogleUtilities/GoogleUtilities/Reachability/Public',
    'Pods/GoogleUtilities/GoogleUtilities/AppDelegateSwizzler/Public',
    'Pods/GoogleUtilities/GoogleUtilities/Environment/Public',
    'Pods/GoogleUtilities/GoogleUtilities/NSData+zlib/Public',
])

# tweak this if you want to use different folders, or more folders, to store your source code in.
sources = Glob('godot-ios-firebase-analytics/*.cpp')
sources.append(Glob('godot-ios-firebase-analytics/*.mm'))
sources.append(Glob('godot-ios-firebase-analytics/*.m'))
